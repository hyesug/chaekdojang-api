...
public class ReadingGoalController {
    ...
    @Operation(summary = "내 독서 목표 저장", description = "올해 독서 목표 권수를 저장합니다. JWT 필요.")
    @PatchMapping("/me/reading-goal")
    public ApiResponse<ReadingGoalResponse> updateMyGoal(@RequestBody @Valid ReadingGoalUpdateRequest request) {
        return ApiResponse.ok(readingGoalService.updateMyGoal(request));
    }
