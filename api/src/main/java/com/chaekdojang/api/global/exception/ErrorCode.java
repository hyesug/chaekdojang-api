...
public enum ErrorCode {
    ...
    CONTEST_NOT_FOUND(HttpStatus.NOT_FOUND, "공모전을 찾을 수 없습니다."),
    CONTEST_NOT_OPEN(HttpStatus.BAD_REQUEST, "지금은 응모를 받지 않는 공모전입니다."),
    CONTEST_TERMS_REQUIRED(HttpStatus.BAD_REQUEST, "공모전 참여 약관에 동의해야 응모할 수 있습니다."),
    CONTEST_ALREADY_ENTERED(HttpStatus.CONFLICT, "이미 응모한 공모전입니다."),
    CONTEST_ENTRY_NOT_FOUND(HttpStatus.NOT_FOUND, "응모 내역을 찾을 수 없습니다."),
    CONTEST_ENTRY_REVIEW_REQUIRED(HttpStatus.BAD_REQUEST, "응모할 독후감을 선택해주세요."),
    CONTEST_ENTRY_TEXT_REQUIRED(HttpStatus.BAD_REQUEST, "응모작 제목과 본문을 모두 입력해주세요."),
    CONTEST_ENTRY_BOOK_REQUIRED(HttpStatus.BAD_REQUEST, "어느 지정 도서로 응모할지 선택해주세요."),
    CONTEST_ENTRY_BOOK_NOT_ALLOWED(HttpStatus.BAD_REQUEST, "이 공모전의 지정 도서로 쓴 글만 응모할 수 있습니다."),
    CONTEST_ENTRY_WITHDRAW_NOT_ALLOWED(HttpStatus.BAD_REQUEST, "접수 기간에 제출한 응모작만 취소할 수 있습니다."),
    CONTEST_INVALID_PERIOD(HttpStatus.BAD_REQUEST, "접수 시작·마감·발표 순서가 올바르지 않습니다."),
    CONTEST_STATUS_TRANSITION_NOT_ALLOWED(HttpStatus.BAD_REQUEST, "현재 상태에서는 변경할 수 없는 단계입니다."),
    CONTEST_AWARD_STAGE_INVALID(HttpStatus.BAD_REQUEST, "접수를 마감한 심사 단계에서만 수상자를 지정할 수 있습니다."),
    CONTEST_AWARD_DUPLICATED(HttpStatus.BAD_REQUEST, "같은 응모작이나 같은 등수를 두 번 지정했습니다."),
    CONTEST_AWARD_ENTRY_INVALID(HttpStatus.BAD_REQUEST, "수상자로 지정할 수 없는 응모작입니다."),
